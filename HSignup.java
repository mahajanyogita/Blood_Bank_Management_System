...
JButton lg,back,reg;
	...
	HSignup()
	{
		...
		background_image = new ImageIcon("images/bg27.jpg");
		...
		background.setBounds(10,0,250,600);
		left.add(background);


		
		title=new JLabel("Hospital Registration",JLabel.CENTER);
		//set bounds left,top,width,height
		title.setBounds(200,0,600,50);		
		title.setFont(f);
...
{
	new HbHospital().HbHospital_register(name,email,pn,pwd,st,ct);
    username.setText("");
    password.setText("");  
    emt.setText("");
    cityt.setText("");
...
lg.addActionListener(a2);
		...
		setSize(900,600);
		setTitle("Blood Bank Management System/Hospital_Signup");
