...
JButton lg,back,reg;
	...
	HLogin()
	{
		...
		background_image = new ImageIcon("images/bg21.jpg");
       ...
       base.setBackground(new Color(255,255,255));
		...
		background.setBounds(110,30,200,200);
		base.add(background);
...
ActionListener a3 = (ae) ->{ HSignup a = new HSignup();dispose();};
reg.addActionListener(a3);
		...
		setSize(900,600);
		setTitle("Blood Bank Management System/Hospital_Login");
