...
JButton lg,back,reg;
	...
	{
		//font
		Font f = new Font("Algrian",Font.BOLD,40);
		Font f1 = new Font("Serif",Font.BOLD,25);
		//set background to frame
		background_image = new ImageIcon("images/bg10.jpg");
...
ActionListener a3 = (ae) ->{ ASignup a = new ASignup();dispose();};
