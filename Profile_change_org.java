...
class Profile_change_org extends JFrame{
...
//////////////////////  -------------------- database part ------------------------////////////////////////
	...
	Profile_change_org(String user,String emailv)
	{
		//font
...
else
{
   ...
   save_prof.save_profile_org(name,email,emailv,pn,st,ct,ap,an,bp,bn,opb,onb,abp,abn);
...
lg.addActionListener(a2);
		...
		setSize(900,600);
		setTitle("Blood Bank Management System/Organization profile");
