class Organization{
	...
	public Organization(String name,String email, Long phone,String password,String state,String city,int ap,int an,int bp,int bn,int abp,int abn,int opb,int onb)
	{
