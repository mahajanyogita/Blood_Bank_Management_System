...
JButton lg,back,reg;
	...
	DLogin()
	{
		...
		background_image = new ImageIcon("images/bg15.jpg");
       ...
       base.setBackground(new Color(255,255,255));
		...
		Image temp_img=img.getScaledInstance(200,150,Image.SCALE_SMOOTH);
		background_image=new ImageIcon(temp_img);
		background=new JLabel("",background_image,JLabel.LEFT);

		// add background image
		background.setBounds(130,30,200,200);
		base.add(background);
...
{
	JOptionPane.showMessageDialog(login,e,"Error",JOptionPane.ERROR_MESSAGE);
...
ActionListener a3 = (ae) ->{ DSignup a = new DSignup();dispose();};
reg.addActionListener(a3);
		...
		setSize(900,600);
		setTitle("Blood Bank Management System/Admin_Login");
